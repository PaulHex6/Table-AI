...
- **Cost Estimation**: Estimate the cost of processing based on the selected model before running the process.
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/yourusername/gpt-excel-processor.git
...
5. **Estimate cost**:
   ...
   Review the estimated cost for processing based on the selected model.
...
7. **Download the processed file**:
   ...
   Once processing is complete, you can download the updated Excel file.
